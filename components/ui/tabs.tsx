...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-lg bg-white/[0.04] border border-white/[0.08] p-1 text-muted-foreground backdrop-blur-xl",
      className
    )}
    {...props}
  />
