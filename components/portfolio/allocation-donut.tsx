  ...
  if (total === 0) {
    return (
      <motion.div
        ...
        className="relative flex h-[300px] flex-col items-center justify-center gap-3 overflow-hidden rounded-3xl border border-white/5 bg-gradient-to-br from-fuchsia-500/5 via-transparent to-transparent p-6 backdrop-blur"
      >
