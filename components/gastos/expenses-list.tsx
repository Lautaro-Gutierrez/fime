  ...
  if (filtered.length === 0) {
    return (
      <motion.div
        ...
        className="relative overflow-hidden rounded-xl border border-white/[0.08] bg-gradient-to-br from-theme-500/10 via-teal-500/5 to-transparent p-12 text-center backdrop-blur"
      >
