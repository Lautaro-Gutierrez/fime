...
export function QuickActions() {
  return (
    <div className="rounded-xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-xl backdrop-blur p-6 flex flex-col gap-4 h-full group hover:border-white/10 transition-colors">
